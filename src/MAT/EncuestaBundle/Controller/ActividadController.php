...
use MAT\EncuestaBundle\Entity\Actividad;
use MAT\EncuestaBundle\Form\ActividadType;
...
class ActividadController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $actividads = $em->getRepository('EncuestaBundle:Actividad')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MAT\EncuestaBundle\Form\ActividadType', $actividad);
    ...
    {
        $deleteForm = $this->createDeleteForm($actividad);
        $editForm = $this->createForm('MAT\EncuestaBundle\Form\ActividadType', $actividad);
