...
use MAT\EncuestaBundle\Entity\Registro;
use MAT\EncuestaBundle\Form\RegistroType;
...
class RegistroController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $registros = $em->getRepository('EncuestaBundle:Registro')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MAT\EncuestaBundle\Form\RegistroType', $registro);
    ...
    {
        $deleteForm = $this->createDeleteForm($registro);
        $editForm = $this->createForm('MAT\EncuestaBundle\Form\RegistroType', $registro);
